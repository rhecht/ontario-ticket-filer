  ...
  <tr>
    ...
    <td><form id="redlight" name="redlight" method="post" action="form_notice_to_appear_submit">
          ...
          <tr>
            ...
            <td>TAKE NOTICE THAT I <div class="inputPDF" style="width:75%;"><?php echo $ttgd_fullname; ?></div>
			</td>
            ...
            <td><table width="100%" border="0" cellspacing="0" cellpadding="0" >
                ...
                <tr>
                  ...
                  <td colspan="3" class="text_box">
                  	<div class="inputPDF" style="width:100%;"><?php echo $ttgd_address; ?></div>
                  </td>
                ...
                <tr>
                  ...
                  <td class="text_box"><div class="inputPDF"><?php echo $ttgd_apt; ?></div></td>

                  <td class="text_box">&nbsp;</td>

                  <td class="text_box"><div class="inputPDF"><?php echo $ttgd_municipality; ?></div></td>
                ...
                <tr>
                  ...
                  <td class="text_box"><div class="inputPDF"><?php echo $ttgd_province_state; ?></div></td>

                  <td class="text_box">&nbsp;</td>

                  <td class="text_box"><div class="inputPDF"><?php echo $ttgd_postal_zip_code; ?></div></td>
          ...
          <tr>
            ...
            <td><table width="100%" border="0" cellspacing="1" cellpadding="1">
                ...
                <tr>
                  ...
                  <div class="inputPDF" style="width:50px;"><?php echo $ttgd_icon; ?></div></td>
                ...
                <tr>
                  ...
                  <td width="31%">
                    ...
                    <div class="inputPDF" style="width:50px;"><?php echo $ttgd_offence_num; ?></div>
                ...
                <tr>
                  ...
                  <td><label>
                    ...
                    <div class="inputPDF" style="width:182px;"><?php echo $ttgd_offence_date; ?></div>
                ...
                <tr>
                  ...
                  <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
                      ...
                      <tr>
                        ...
                        <td width="24%"><label>
                            ...
                            <?php if ($ttgd_officer_attend_trial==0){ echo "&#10003;";} ?>
                  ...
                  <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
                      ...
                      <tr>
                        ...
                        <td width="61%"><?php if ($ttgd_officer_attend_trial==1){ echo "&#10003;";} ?>
            ...
            <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
                ...
                <tr>
                  ...
                  <td width="49%"><label>
                    ...
                    <?php if ($ttgd_intend_to_appear_in_court==0){}else{ echo "&#10003;"; } ?>
                  ...
                  <td width="51%"><label>
                    ...
                    <?php if ($ttgd_intend_to_appear_in_court_fr==0){}else{ echo "&#10003;"; } ?>
                ...
                <tr>
                  ...
                  <td>I request a
                    ...
                    <div class="inputPDF"><?php echo $ttgd_languageinterpreter; ?></div></label>
                  ...
                  <td><i>Je demande l’aide d’un interprète de langue
                    ...
                    <div class="inputPDF"><?php echo $ttgd_fr_languageinterpreter; ?></div>
            ...
            <td><table width="100%" border="0" cellspacing="1" cellpadding="1">
                ...
                <tr>
                  ...
                  <td><label>
                    ...
                    <?php if ($ttgd_intend_to_appear_in_court==1){}else{ echo "&#10003;"; }?>
                  ...
                  <td><label>
                    ...
                    <?php if ($ttgd_intend_to_appear_in_court_fr==1){}else{ echo "&#10003;"; }?>
                ...
                <tr>
                  ...
                  <td><label>
                    ...
                    <div class="inputPDF" style="width:350px;"><?php echo $ttgd_signature; ?></div>
                  ...
                  <td valign="top"><label>
                    ...
                    <div class="inputPDF"><?php echo $ttgd_signature_date; ?></div>
                    </label>
