...
<table align="center" width="70%" border="0" cellspacing="2" cellpadding="2" >
  ...
  <tr bgcolor="#E6E6E6">
    ...
    <td style="font-size:14px;">Please Enter your Parking Ticket Offence Date:</td>
  ...
  <tr>
    ...
    <td colspan="2" style="font-size:14px;">a) In order for us to file your Parking Ticket, issued by the City Of Toronto, it needs to be less than 30 days old.</td>
  ...
  <tr>
    ...
    <td colspan="2" style="font-size:14px;">b) If you received your Parking Ticket more than 30 days ago, we unfortunately are unable to file it. Sorry! <br />
...
<script language="<?php echo base_url(); ?>javascript" type="text/javascript">
