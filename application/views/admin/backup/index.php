...
<link rel="stylesheet" type="text/css"  media="screen" href="<?php echo base_url(); ?>css/admin/style.css" />
<script type="text/javascript" src="<?php echo base_url(); ?>js/admin/clockp.js"></script>
<script type="text/javascript" src="<?php echo base_url(); ?>js/admin/clockh.js"></script> 
<script type="text/javascript" src="<?php echo base_url(); ?>js/admin/jquery.min.js"></script>
<script type="text/javascript" src="<?php echo base_url(); ?>js/admin/ddaccordion.js"></script>
...
ddaccordion.init({
	...
	togglehtml: ["suffix", "<img src='<?php echo base_url(); ?>images/admin/images/plus.gif' class='statusicon' />", "<img src='<?php echo base_url(); ?>images/admin/images/minus.gif' class='statusicon' />"], //Additional HTML added to the header when it's collapsed and expanded, respectively  ["position", "html1", "html2"] (see docs)
...
<script type="text/javascript" src="<?php echo base_url(); ?>/js/admin/jconfirmaction.jquery.js"></script>
<script type="text/javascript">
...
<script language="javascript" type="text/javascript" src="<?php echo base_url(); ?>js/admin/niceforms.js"></script>
<link rel="stylesheet" type="text/css" media="screen" href="<?php echo base_url(); ?>css/admin/niceforms-default.css" />
...
<div id="main_container">
    ...
    <div class="left_content">
            ...
            <input type="image" class="search_submit" src="<?php echo base_url(); ?>images/admin/images/search.png" />
            </form>            
            </div>
            ...
            <div class="sidebar_box">
                ...
                <img src="<?php echo base_url(); ?>images/admin/images/info.png" alt="" title="" class="sidebar_icon_right" />
                <p>
Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.
            ...
            <div class="sidebar_box">
                ...
                <img src="<?php echo base_url(); ?>images/admin/images/notice.png" alt="" title="" class="sidebar_icon_right" />
                <p>
Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.
                </p>                
                </div>
            ...
            <div class="sidebar_box">
                ...
                <img src="<?php echo base_url(); ?>images/admin/images/photo.png" alt="" title="" class="sidebar_icon_right" />
                <p>
Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.
                </p>                
                </div>
...
<table id="rounded-corner" summary="2007 Major IT Companies' Profit">
    ...
    <div class="footer">
    	...
    	<div class="right_footer"><a href="http://indeziner.com"><img src="<?php echo base_url(); ?>images/admin/images/indeziner_logo.gif" alt="" title="" border="0" /></a></div>
